...
def generate_similar_image_to_video(images=[], prompts=[], fps=5, file_path='video.mp4', two_img=False, to_cuda=True):

    video_seconds = []

    for img, prompt in zip(images, prompts):        
        video_seconds.append(__generate_3d_from_image_text(img, prompt, to_cuda=to_cuda))
